...
Random tipster/predictor repos without time-ordered validation/model cards/reproducibility; black-box ML merely because reported accuracy is high; fixed Kelly staking as direction engine; any model with closing-odds leakage into earlier pre-match predictions.
